...
//        setBackgroundResource(R.drawable.navigation_bg);
        ...
        btn_left.setTag(new Integer(LEFT_BTN));
        ...
        } else
        {
            ...
            btn_left.setBackgroundResource(R.mipmap.back);// 设置背景
        }
        ...
        btn_right.setTag(new Integer(RIGHT_BTN));
...
//        btn_right.setBackgroundResource(R.drawable.buttonbg);// 设置背景
        ...
        } else
        {
            ...
            btn_right.setBackgroundResource(R.mipmap.next);// 设置背景
        }
        if (null != strBtnRight)
        {
    ...
    public void onClick(View v)
    {
        ...
        if (mListener != null)
        {
            System.out.println("click" + which);
